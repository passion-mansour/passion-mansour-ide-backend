...
public class ProjectRepositoryImpl implements ProjectRepository {
    ...
    private RowMapper<Project> projectRowMapper() {
        return ((rs, rowNum) -> {
            ...
            project.setCreateDateTime(rs.getTimestamp("project.createDt").toLocalDateTime());
            project.setEndDateTime(rs.getTimestamp("project.endDt").toLocalDateTime());
    ...
    public Project save(Project project) {
        ...
        params.put("endDt", project.getEndDateTime());
